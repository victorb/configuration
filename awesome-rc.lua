...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1 www", "2 term", "3 media", "4 mail", "5 chat", "6 editor", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Pause", function () awful.util.spawn_with_shell("xscreensaver &xscreensaver-command -lock") end),
    awful.key({ }, "Scroll_Lock", function () 
      gotLine = false
      url = ""
      text = ""
      awful.spawn.with_line_callback("/home/user/current-todo.sh", {
        stdout = function(line)
          if gotLine then
            ...
            naughty.notify {
              ...
              text = text,
              actions = {
                -- TODO add a action to mark current task as done
                browser = function ()
                  awful.util.spawn_with_shell("firefox " .. url)
                end
              }
            }
          else
    ...
    -- echo "https://ipfs.io/ipfs/$(maim -s | ipfs add -Q)" | xsel -b
)
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox" },
      properties = { screen = 1, tag = "1 www" } },
    -- { rule = { class = "Alacritty" },
    --   properties = { screen = 1, tag = "2 term" } },
    { rule = { class = "[Ss]potify" },
      properties = { screen = 1, tag = "3 media" } },
    { rule = { class = "Pavucontrol" },
      properties = { screen = 1, tag = "3 media" } },
    { rule = { class = "Thunderbird" },
      properties = { screen = 1, tag = "4 mail" } },
    { rule = { class = "IRCCloud" },
...
awful.util.spawn_with_shell("/home/user/autorun.sh")
